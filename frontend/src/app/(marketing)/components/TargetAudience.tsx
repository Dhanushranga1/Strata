...
const accentClasses: Record<string, { icon: string; tag: string }> = {
  indigo: {
    ...
    tag: 'text-indigo-400 border-indigo-800/50',
  },
  violet: {
    icon: 'text-violet-400',
    tag: 'text-violet-400 border-violet-800/50',
  },
  cyan: { icon: 'text-cyan-400', tag: 'text-cyan-400   border-cyan-800/50' },
  emerald: {
    icon: 'text-emerald-400',
    tag: 'text-emerald-400 border-emerald-800/50',
  },
};
  ...
  return (
    <section className="mx-auto max-w-6xl px-6 py-16 lg:py-24">
      <div className="text-center mb-12">
        ...
        >
          Whether you&apos;re a startup with two reps or an enterprise org with
          hundreds of daily tickets, TicketPilot scales with you.
        </motion.p>
      </div>
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="font-semibold text-white font-geist">
                    {p.title}
                  </h3>
                </div>
              </div>
              ...
              <div className="space-y-2.5 text-sm">
                <div className="flex gap-2">
                  <span className="text-red-400 font-medium shrink-0 text-xs uppercase tracking-wide mt-0.5">
                    Problem
                  </span>
                ...
                <div className="flex gap-2">
                  <span className="text-green-400 font-medium shrink-0 text-xs uppercase tracking-wide mt-0.5">
                    Solution
                  </span>
